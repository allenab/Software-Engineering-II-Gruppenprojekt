...
public class Wall extends GameObject {
    ...
    public void load(World world) {
        body = Box2DHelper.createBox(this,world, position.x, position.y, bounds.width, bounds.height, BodyDef.BodyType.StaticBody, false, Box2DHelper.BIT_WALL, Box2DHelper.BIT_PLAYER, Box2DHelper.BIT_WALL);
